    ...
    try {
      ...
      if (dbUrl && dbToken) {
        ...
        await unifiedRemote.exec(`
            ...
            CREATE TABLE IF NOT EXISTS users (id INTEGER PRIMARY KEY AUTOINCREMENT, name TEXT UNIQUE, password TEXT, role TEXT, email TEXT, phone TEXT, bio TEXT, title TEXT, avatarBase64 TEXT);
